...
# This defines the EXACT "intake form" — what input we expect
...
@app.get("/")
def read_root():
    return {"message": "Hello from your first API! The front desk is open."}

@app.post("/predict")
def predict(patient: PatientData):
    # Convert the incoming data into the exact shape the model expects
    input_data = np.array([[
